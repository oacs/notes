...
function addFilterInput(filter, el, idx, plugin) {
  ...
  const patternField = new import_obsidian5.TextComponent(el);
  ...
  const replaceField = new import_obsidian5.TextComponent(el);
  ...
  const flagField = new import_obsidian5.TextComponent(el);
  ...
  const removeButton = new import_obsidian5.ButtonComponent(el);
...
var SettingView = class {
  constructor(app, settingsRootElement, settings, saveSettings) {
    this.debouncedSaveAndUpdate = (0, import_obsidian6.debounce)(this.saveSiteSettingsAndUpdateEnv, 500, true);
    this.app = app;
  ...
  initialize(prModal) {
    return __async(this, null, function* () {
      ...
      this.settingsRootElement.createEl("h3", { text: "GitHub Authentication (required)" }).prepend((0, import_obsidian6.getIcon)("github"));
      this.initializeGitHubRepoSetting();
      this.initializeGitHubUserNameSetting();
      this.initializeGitHubTokenSetting();
      this.settingsRootElement.createEl("h3", { text: "URL" }).prepend((0, import_obsidian6.getIcon)("link"));
      this.initializeGitHubBaseURLSetting();
      this.initializeSlugifySetting();
      this.settingsRootElement.createEl("h3", { text: "Features" }).prepend((0, import_obsidian6.getIcon)("star"));
      this.initializeDefaultNoteSettings();
      this.settingsRootElement.createEl("h3", { text: "Appearance" }).prepend((0, import_obsidian6.getIcon)("brush"));
      this.initializeThemesSettings();
      this.settingsRootElement.createEl("h3", { text: "Advanced" }).prepend((0, import_obsidian6.getIcon)("cog"));
  ...
  initializeDefaultNoteSettings() {
    return __async(this, null, function* () {
      const noteSettingsModal = new import_obsidian6.Modal(this.app);
      ...
      new import_obsidian6.Setting(this.settingsRootElement).setName("Global Note Settings").setDesc(`Default settings for each published note. These can be overwritten per note via frontmatter.`).addButton((cb) => {
        cb.setButtonText("Manage note settings");
        cb.onClick(() => __async(this, null, function* () {
          noteSettingsModal.open();
        }));
      });
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Show home link (dg-home-link)").setDesc("Determines whether to show a link back to the homepage or not.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Show local graph for notes (dg-show-local-graph)").setDesc("When turned on, notes will show its local graph in a sidebar on desktop and at the bottom of the page on mobile.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Show backlinks for notes (dg-show-backlinks)").setDesc("When turned on, notes will show backlinks in a sidebar on desktop and at the bottom of the page on mobile.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Show a table of content for notes (dg-show-toc)").setDesc("When turned on, notes will show all headers as a table of content in a sidebar on desktop. It will not be shown on mobile devices.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Show inline title (dg-show-inline-title)").setDesc("When turned on, the title of the note will show on top of the page.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Show filetree sidebar (dg-show-file-tree)").setDesc("When turned on, a filetree will be shown on your site.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Enable search (dg-enable-search)").setDesc("When turned on, users will be able to search through the content of your site.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Enable link preview (dg-link-preview)").setDesc("When turned on, hovering over links to notes in your garden shows a scrollable preview.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Show Tags (dg-show-tags)").setDesc("When turned on, tags in your frontmatter will be displayed on each note. If search is enabled, clicking on a tag will bring up a search for all notes containing that tag.").addToggle((t) => {
      ...
      new import_obsidian6.Setting(noteSettingsModal.contentEl).setName("Let all frontmatter through (dg-pass-frontmatter)").setDesc("Determines whether to let all frontmatter data through to the site template. Be aware that this could break your site if you have data in a format not recognized by the template engine, 11ty.").addToggle((t) => {
  ...
  initializeThemesSettings() {
    return __async(this, null, function* () {
      const themeModal = new import_obsidian6.Modal(this.app);
      themeModal.containerEl.addClass("dg-settings");
      themeModal.titleEl.createEl("h1", { text: "Appearance Settings" });
      new import_obsidian6.Setting(this.settingsRootElement).setName("Appearance").setDesc("Manage themes, sitename and styling on your site").addButton((cb) => {
      ...
      try {
        if (this.app.plugins && this.app.plugins.plugins["obsidian-style-settings"]._loaded) {
          themeModal.contentEl.createEl("h2", { text: "Style Settings Plugin" }).prepend((0, import_obsidian6.getIcon)("paintbrush"));
          new import_obsidian6.Setting(themeModal.contentEl).setName("Apply current style settings to site").setDesc("Click the apply button to use the current style settings from the Style Settings Plugin on your site.").addButton((btn) => {
            btn.setButtonText("Apply");
            btn.onClick((ev) => __async(this, null, function* () {
              new import_obsidian6.Notice("Applying Style Settings...");
              const styleSettingsNode = document.querySelector("#css-settings-manager");
              if (!styleSettingsNode) {
                new import_obsidian6.Notice("No Style Settings found");
                return;
              }
              ...
              this.saveSiteSettingsAndUpdateEnv(this.app.metadataCache, this.settings, this.saveSettings);
              new import_obsidian6.Notice("Style Settings applied to site");
            }));
          });
        }
      } catch (e) {
      }
      themeModal.contentEl.createEl("h2", { text: "Theme Settings" }).prepend((0, import_obsidian6.getIcon)("palette"));
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Theme").addDropdown((dd) => {
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Base theme").addDropdown((dd) => {
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Sitename").setDesc("The name of your site. This will be displayed as the site header.").addText((text) => text.setValue(this.settings.siteName).onChange((value) => __async(this, null, function* () {
        this.settings.siteName = value;
        yield this.saveSettings();
      })));
      new import_obsidian6.Setting(themeModal.contentEl).setName("Favicon").setDesc("Path to an svg in your vault you wish to use as a favicon. Leave blank to use default.").addText((tc) => {
      ...
      themeModal.contentEl.createEl("h2", { text: "Timestamps Settings" }).prepend((0, import_obsidian6.getIcon)("calendar-clock"));
      new import_obsidian6.Setting(themeModal.contentEl).setName("Timestamp format").setDesc("The format string to render timestamp on the garden. Must be luxon compatible").addText((text) => text.setValue(this.settings.timestampFormat).onChange((value) => __async(this, null, function* () {
        this.settings.timestampFormat = value;
        yield this.saveSettings();
      })));
      new import_obsidian6.Setting(themeModal.contentEl).setName("Show created timestamp").addToggle((t) => {
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Show updated timestamp").addToggle((t) => {
      ...
      themeModal.contentEl.createEl("h2", { text: "CSS settings" }).prepend((0, import_obsidian6.getIcon)("code"));
      new import_obsidian6.Setting(themeModal.contentEl).setName("Body Classes Key").setDesc("Key for setting css-classes to the note body from the frontmatter.").addText((text) => text.setValue(this.settings.contentClassesKey).onChange((value) => __async(this, null, function* () {
        this.settings.contentClassesKey = value;
        yield this.saveSettings();
      })));
      themeModal.contentEl.createEl("h2", { text: "Note icons Settings" }).prepend((0, import_obsidian6.getIcon)("image"));
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Note icon Frontmatter Key").setDesc("Key to get the note icon value from the frontmatter").addText((text) => text.setValue(this.settings.noteIconKey).onChange((value) => __async(this, null, function* () {
        this.settings.noteIconKey = value;
        yield this.saveSettings();
      })));
      new import_obsidian6.Setting(themeModal.contentEl).setName("Default note icon Value").setDesc("The default value for note icon if not specified").addText((text) => {
        text.setValue(this.settings.defaultNoteIcon).onChange((value) => __async(this, null, function* () {
          this.settings.defaultNoteIcon = value;
          yield this.saveSettings();
        }));
      });
      new import_obsidian6.Setting(themeModal.contentEl).setName("Show note icon on Title").addToggle((t) => {
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Show note icon in FileTree").addToggle((t) => {
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Show note icon on Internal Links").addToggle((t) => {
      ...
      new import_obsidian6.Setting(themeModal.contentEl).setName("Show note icon on Backlinks").addToggle((t) => {
      ...
      new import_obsidian6.Setting(themeModal.contentEl).addButton((cb) => {
  ...
  saveSettingsAndUpdateEnv() {
    return __async(this, null, function* () {
      ...
      if (theme.modes.indexOf(baseTheme) < 0) {
        new import_obsidian6.Notice(`The ${theme.name} theme doesn't support ${baseTheme} mode.`);
        return;
      }
      const gardenManager = new DigitalGardenSiteManager(this.app.metadataCache, this.settings);
      yield gardenManager.updateEnv();
      new import_obsidian6.Notice("Successfully applied settings");
    });
  }
  saveSiteSettingsAndUpdateEnv(metadataCache, settings, saveSettings) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        new import_obsidian6.Notice("Failed to update settings. Make sure you have an internet connection.");
        updateFailed = true;
      }
      if (!updateFailed) {
        yield saveSettings();
  ...
  addFavicon(octokit) {
    return __async(this, null, function* () {
      ...
      if (this.settings.faviconPath) {
        ...
        if (!(faviconFile instanceof import_obsidian6.TFile)) {
          new import_obsidian6.Notice(`${this.settings.faviconPath} is not a valid file.`);
          return;
        }
  ...
  initializeGitHubRepoSetting() {
    new import_obsidian6.Setting(this.settingsRootElement).setName("GitHub repo name").setDesc("The name of the GitHub repository").addText((text) => text.setPlaceholder("mydigitalgarden").setValue(this.settings.githubRepo).onChange((value) => __async(this, null, function* () {
      this.settings.githubRepo = value;
      yield this.saveSettings();
    })));
  }
  initializeGitHubUserNameSetting() {
    new import_obsidian6.Setting(this.settingsRootElement).setName("GitHub Username").setDesc("Your GitHub Username").addText((text) => text.setPlaceholder("myusername").setValue(this.settings.githubUserName).onChange((value) => __async(this, null, function* () {
  ...
  initializeGitHubTokenSetting() {
    ...
    new import_obsidian6.Setting(this.settingsRootElement).setName("GitHub token").setDesc(desc).addText((text) => text.setPlaceholder("Secret Token").setValue(this.settings.githubToken).onChange((value) => __async(this, null, function* () {
      this.settings.githubToken = value;
      yield this.saveSettings();
    })));
  }
  initializeGitHubBaseURLSetting() {
    new import_obsidian6.Setting(this.settingsRootElement).setName("Base URL").setDesc(`
  ...
  initializeSlugifySetting() {
    new import_obsidian6.Setting(this.settingsRootElement).setName("Slugify Note URL").setDesc('Transform the URL from "/My Folder/My Note/" to "/my-folder/my-note". If your note titles contains non-English characters, this should be disabled.').addToggle((toggle) => toggle.setValue(this.settings.slugifyEnabled).onChange((value) => __async(this, null, function* () {
      this.settings.slugifyEnabled = value;
      yield this.saveSettings();
    })));
  }
  initializePathRewriteSettings() {
    const rewriteRulesModal = new import_obsidian6.Modal(this.app);
    rewriteRulesModal.titleEl.createEl("h1", { text: "Path Rewrite Rules" });
    rewriteRulesModal.modalEl.style.width = "fit-content";
    new import_obsidian6.Setting(this.settingsRootElement).setName("Path Rewrite Rules").setDesc("Define rules to rewrite note folder structure in the garden. See the modal for more information.").addButton((cb) => {
    ...
    new import_obsidian6.Setting(rewritesettingContainer).setName("Rules").addTextArea((field) => {
  ...
  initializeCustomFilterSettings() {
    const customFilterModal = new import_obsidian6.Modal(this.app);
    customFilterModal.titleEl.createEl("h1", { text: "Custom Filters" });
    customFilterModal.modalEl.style.width = "fit-content";
    new import_obsidian6.Setting(this.settingsRootElement).setName("Custom Filters").setDesc("Define custom rules to replace parts of the note before publishing.").addButton((cb) => {
    ...
    new import_obsidian6.Setting(rewritesettingContainer).setName("Filters").addButton((button) => {
  ...
  renderCreatePr(modal, handlePR) {
    this.settingsRootElement.createEl("h3", { text: "Update site" }).prepend((0, import_obsidian6.getIcon)("sync"));
    new import_obsidian6.Setting(this.settingsRootElement).setName("Site Template").setDesc("Manage updates to the base template. You should try updating the template when you update the plugin to make sure your garden support all features.").addButton((button) => {
    ...
    new import_obsidian6.Setting(modal.contentEl).setName("Update site to latest template").setDesc(`
    ...
    this.settingsRootElement.createEl("h3", { text: "Support" }).prepend((0, import_obsidian6.getIcon)("heart"));
...
var PublishModal = class {
  ...
  createCollapsable(title, buttonText, buttonCallback) {
    ...
    if (buttonText && buttonCallback) {
      const button = new import_obsidian7.ButtonComponent(headerContainer).setButtonText(buttonText).onClick(() => __async(this, null, function* () {
...
var DigitalGarden = class extends import_obsidian8.Plugin {
  onload() {
    return __async(this, null, function* () {
      ...
      (0, import_obsidian8.addIcon)("digital-garden-icon", seedling);
    ...
    return __async(this, null, function* () {
      this.addCommand({
        ...
        callback: () => __async(this, null, function* () {
          new import_obsidian8.Notice("Adding publish flag to note and publishing it.");
      ...
      this.addCommand({
        ...
        callback: () => __async(this, null, function* () {
          ...
          try {
            new import_obsidian8.Notice("Processing files to publish...");
            ...
            new import_obsidian8.Notice(`Publishing ${filesToPublish.length} notes, deleting ${filesToDelete.length} notes and ${imagesToDelete.length} images. See the status bar in lower right corner for progress.`, 8e3);
            for (const file of filesToPublish) {
              try {
                ...
                errorFiles++;
                new import_obsidian8.Notice(`Unable to publish note ${file.name}, skipping it.`);
              }
            }
            for (const filePath of filesToDelete) {
              try {
                ...
                errorDeleteFiles++;
                new import_obsidian8.Notice(`Unable to delete note ${filePath}, skipping it.`);
              }
            }
            for (const filePath of imagesToDelete) {
              try {
                ...
                errorDeleteImage++;
                new import_obsidian8.Notice(`Unable to delete image ${filePath}, skipping it.`);
              }
            }
            statusBar.finish(8e3);
            new import_obsidian8.Notice(`Successfully published ${filesToPublish.length - errorFiles} notes to your garden.`);
            if (filesToDelete.length > 0) {
              new import_obsidian8.Notice(`Successfully deleted ${filesToDelete.length - errorDeleteFiles} notes from your garden.`);
            }
            if (imagesToDelete.length > 0) {
              new import_obsidian8.Notice(`Successfully deleted ${imagesToDelete.length - errorDeleteImage} images from your garden.`);
            }
          } catch (e) {
            statusBarItem.remove();
            console.error(e);
            new import_obsidian8.Notice("Unable to publish multiple notes, something went wrong.");
          }
        })
      });
      this.addCommand({
  ...
  copyGardenUrlToClipboard() {
    return __async(this, null, function* () {
      try {
        ...
        if (!currentFile) {
          new import_obsidian8.Notice("No file is open/active. Please open a file and try again.");
          return;
        }
        const siteManager = new DigitalGardenSiteManager(metadataCache, this.settings);
        const fullUrl = siteManager.getNoteUrl(currentFile);
        yield navigator.clipboard.writeText(fullUrl);
        new import_obsidian8.Notice(`Note URL copied to clipboard`);
      } catch (e) {
        console.log(e);
        new import_obsidian8.Notice("Unable to copy note URL to clipboard, something went wrong.");
      }
    });
  }
  publishSingleNote() {
    return __async(this, null, function* () {
      try {
        ...
        if (currentFile.extension !== "md") {
          new import_obsidian8.Notice("The current file is not a markdown file. Please open a markdown file and try again.");
          return;
        }
        new import_obsidian8.Notice("Publishing note...");
        const publisher = new Publisher(vault, metadataCache, this.settings);
        const publishSuccessful = yield publisher.publish(currentFile);
        if (publishSuccessful) {
          new import_obsidian8.Notice(`Successfully published note to your garden.`);
        }
        return publishSuccessful;
      } catch (e) {
        console.error(e);
        new import_obsidian8.Notice("Unable to publish note, something went wrong.");
        return false;
      }
    });
  }
...
var DigitalGardenSettingTab = class extends import_obsidian8.PluginSettingTab {
  ...
  display() {
    return __async(this, null, function* () {
      ...
      const prModal = new import_obsidian8.Modal(this.app);
